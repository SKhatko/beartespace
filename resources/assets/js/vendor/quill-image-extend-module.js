...
//判断当前浏览器 add by boomer 2018-05-18 15:49:54
var isIEBower = function () {
 ...
 */
var QuillWatch = exports.QuillWatch = {
    watcher: {}, // 登记编辑器信息
...
var ImageExtend = exports.ImageExtend = function () {
    /**
            ...
            if (clipboardData) {
                ...
                if (item && item.kind === 'file' && item.type.match(/^image\//i)) {
                    ...
                    if (isIEBower()) {
                        ...
                        if (!self.file.name) {
                            // self.file.lastModifiedDate = ;
                            // self.file.name = ;
                            var bole = self.file;
                            self.file = new File([bole], "image.png", { type: "image/png", lastModified: new Date() });
                        }
 ...
 *@description 全部工具栏
 */
var container = exports.container = [['bold', 'italic', 'underline', 'strike'], ['blockquote', 'code-block'], [{ 'header': 1 }, { 'header': 2 }], [{ 'list': 'ordered' }, { 'list': 'bullet' }], [{ 'script': 'sub' }, { 'script': 'super' }], [{ 'indent': '-1' }, { 'indent': '+1' }], [{ 'direction': 'rtl' }], [{ 'size': ['small', false, 'large', 'huge'] }], [{ 'header': [1, 2, 3, 4, 5, 6, false] }], [{ 'color': [] }, { 'background': [] }], [{ 'font': [] }], [{ 'align': [] }], ['clean'], ['link', 'image', 'video']];